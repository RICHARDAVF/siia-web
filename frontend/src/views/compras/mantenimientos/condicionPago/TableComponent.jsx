                ...
                return (
                    <div style={{ display: 'flex', flexWrap: 'wrap', justifyContent: 'space-between' }}>
                        {row.dias.map((value, index) => (
                            <strong style={{
                                borderWidth: 1, paddingRight: 4, paddingLeft: 4, borderRadius: 5, borderColor: 'black', background: '#ffeaed', borderStyle: 'solid', fontSize: 10, height: '20px',
                                lineHeight: '20px',
                                display: 'inline-block', textAlign: 'center',
                                verticalAlign: 'middle'
                            }} key={index}>{value}</strong>
                        ))}
                    </div>
                )
